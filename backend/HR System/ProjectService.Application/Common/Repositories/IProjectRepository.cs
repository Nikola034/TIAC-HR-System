...
public interface IProjectRepository
{
    ...
    public Task<IEnumerable<Project>> GetAllProjectsAsync(int pageNumber,int itemNumber, string title, string description, string clientName, CancellationToken ct = default(CancellationToken));
    ...
    public Task<int> GetTotalPageNumber(int itemNumber, string title, string description, string clientName, CancellationToken ct = default(CancellationToken));
