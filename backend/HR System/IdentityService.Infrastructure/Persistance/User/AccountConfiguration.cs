...
namespace Infrastructure.Persistance.User
{
    public class AccountConfiguration : IEntityTypeConfiguration<Core.Entities.Account>
    {
        public void Configure(EntityTypeBuilder<Core.Entities.Account> builder)
        {
            ...
            builder.Property(x => x.Password).HasColumnName("password").HasColumnType("varchar(40)");
            builder.Property(x => x.RefreshToken).HasColumnName("refreshtoken").HasColumnType("varchar(40)");
            builder.Property(x => x.PasswordResetToken).HasColumnName("passwordresettoken").HasColumnType("varchar(40)");
