...
import { GetAllHolidayRequestApproversByApproverIdDto, GetAllHolidayRequestApproversByApproverIdResponse } from '../dtos/holiday-request/get-all-holiday-request-approves-by-approverid.dto';
...
export class HolidayRequestApproverService {
  ...
  getAllHolidayRequestApproversByApproverId(approverId : string): Observable<GetAllHolidayRequestApproversByApproverIdResponse> {
    return this.http.get<GetAllHolidayRequestApproversByApproverIdResponse>(`${this.baseUrl}` + '/byApprover/' + approverId);
  }
